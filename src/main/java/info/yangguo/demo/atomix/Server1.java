...
public class Server1 {
    public static void main(String[] args) {
        ...
        Atomix atomix = Atomix.builder()
                .withMemberId(member1.id())
                .withAddress(member1.address())
                ...
                .withManagementGroup(RaftPartitionGroup.builder("system")
                        ...
                        .withDataDirectory(new File(String.format("target/perf-logs/%s/system", member1.id())))
                        .build())
                .withPartitionGroups(RaftPartitionGroup.builder("data")
                        ...
                        .withDataDirectory(new File(String.format("target/perf-logs/%s/data", member1.id())))
                        .build())
                .build();
        atomix.start().join();
