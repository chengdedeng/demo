...
public class Server2 {
    public static void main(String[] args) {
        ...
        Atomix atomix = Atomix.builder()
                .withMemberId(member2.id())
                .withAddress(member2.address())
                ...
                .withManagementGroup(RaftPartitionGroup.builder("system")
                        ...
                        .withDataDirectory(new File(String.format("target/perf-logs/%s/system", member2.id())))
                        .build())
                .withPartitionGroups(RaftPartitionGroup.builder("data")
                        ...
                        .withDataDirectory(new File(String.format("target/perf-logs/%s/data", member2.id())))
                        .build())
                .build();
        atomix.start().join();
