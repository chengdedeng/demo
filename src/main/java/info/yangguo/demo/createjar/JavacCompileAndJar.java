...
public class JavacCompileAndJar {
    ...
    public JavacCompileAndJar(String javaSourcePath, String javaClassPath, String targetPath, HashMap attributes) {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        String currentDir = "/Users/yangguo/work/code/demo";
        ...
        JavacCompileAndJar javacCompileAndJar = new JavacCompileAndJar(javaSourcePath, javaClassPath, targetPath, attributes);
